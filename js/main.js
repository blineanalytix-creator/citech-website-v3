...
(function () {
    ...
    const ContactTab = {
        init() {
            ...
            const contactPath = isSubpage ? 'kontakt' : 'pages/kontakt';

            const html = `
                <div class="contact-tab" id="contactTab" role="complementary" aria-label="Kontakt-Schnellzugriff">
                    <button class="contact-tab-trigger" aria-expanded="false">Kontakt</button>
                    <div class="contact-tab-content">
                        <div class="contact-tab-title">Kontakt</div>
                        <a href="tel:+4920189096817" class="contact-tab-item">
                            ...
                            <span class="contact-tab-text"><span class="contact-tab-label">Telefon</span><span class="contact-tab-value">0201 89096817</span></span>
                        </a>
                        <a href="mailto:info@citech-ai.de" class="contact-tab-item">
                            ...
                            <span class="contact-tab-text"><span class="contact-tab-label">E-Mail</span><span class="contact-tab-value">info@citech-ai.de</span></span>
                        </a>
                        <a href="${contactPath}" class="contact-tab-item">
                            ...
                            <span class="contact-tab-text"><span class="contact-tab-label">Formular</span><span class="contact-tab-value">Nachricht senden</span></span>
                        </a>
                    </div>
                </div>`;
